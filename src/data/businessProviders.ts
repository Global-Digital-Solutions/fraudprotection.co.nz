...
export const businessProviders: BusinessProvider[] = [
  {
    ...
    name: 'Chubb NZ',
    type: 'insurer',
    tagline: 'FraudProtector — NZ\'s leading commercial crime policy',
    description: 'Chubb\'s FraudProtector policy is purpose-built for NZ businesses. Covers internal crime (employee fraud, embezzlement), external crime (computer fraud, forgery, counterfeit currency), physical asset theft, client loss, and defence costs.',
  ...
  },
  {
    ...
    description: 'NZI\'s Cyber Base and Cyber Ultra products cover a wide range of cyber threats for NZ businesses, from data breach and ransomware through to cyber fraud and third-party liability.',
  ...
  },
  {
    ...
    type: 'insurer',
    tagline: 'Cyber Liability up to $10m for NZ businesses',
    description: 'Delta Insurance provides specialist cyber liability insurance in NZ up to $10 million. Coverage includes business interruption, third-party liability, hacker theft, network extortion, and forensic investigation costs.',
  ...
  },
  {
    ...
    name: 'Marsh NZ',
    type: 'broker',
    tagline: 'Global broking expertise for NZ cyber and crime risk',
    description: 'Marsh NZ is a leading insurance broker placing cyber and commercial crime risks for NZ corporates and mid-market businesses. Coverage encompasses business interruption, repair costs, PR response, legal fees, and fraud/phishing protection.',
  ...
  },
  {
    ...
    type: 'broker',
    tagline: 'NZ fidelity and fraud insurance specialists',
    description: 'Rothbury is one of NZ\'s largest and most trusted insurance brokers, offering fidelity insurance to protect businesses from employee dishonesty, fraud, and criminal acts — whether discovered or undiscovered.',
  ...
  },
  {
    ...
    type: 'broker',
    tagline: 'Fidelity insurance for NZ SMEs and corporates',
  ...
  },
  {
    ...
    description: 'AIG offers commercial crime and cyber insurance solutions for mid-market to large NZ businesses, with global reach and specialist underwriting expertise.',
