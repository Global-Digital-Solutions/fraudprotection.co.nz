...
export const businessSectors: BusinessSector[] = [
  {
    ...
    name: 'Small Business',
    icon: '🏪',
    tagline: 'Affordable fraud protection for SMEs — from sole traders to businesses with 20 staff.',
    ...
    metaTitle: 'Small Business Fraud Insurance NZ | SME Fidelity & Cyber Cover | FraudInsurance.co.nz',
    ...
    faqs: [
      { question: 'Is fraud insurance affordable for small businesses?', answer: 'Yes — fidelity insurance for SMEs can start from $800-$1,500 per year, and basic cyber insurance from $1,500-$3,000 per year. For a business with $1-5m revenue, this is a modest cost compared to the potential loss from a single fraud event, which averages $50,000+ for local SMEs.' },
      { question: 'We\'re a small team — do we really need fraud insurance?', answer: 'Smaller teams can mean less segregation of duties and more reliance on individual trust. This actually increases fraud risk. Many of the most significant employee frauds have occurred in small businesses where a single trusted person controlled both accounts and payments with limited oversight.' },
    ],
  },
  {
    ...
    icon: '🏦',
    tagline: 'Comprehensive fraud protection for financial services firms, lenders, and payment processors.',
    description: 'Financial services businesses face the highest fraud exposure of any sector — managing client funds, processing transactions, and holding sensitive financial data. Commercial crime, cyber insurance, and professional indemnity all intersect for finance sector businesses. Regulatory requirements under the FMCA may also mandate certain fraud controls.',
    heroImage: 'https://images.unsplash.com/photo-1501167786227-4cba60f6d58f?w=1600&q=80',
    metaTitle: 'Finance Sector Fraud Insurance NZ | Banks, Lenders & Financial Services | FraudInsurance.co.nz',
    ...
    faqs: [
      { question: 'Are financial advisers required to hold fraud insurance?', answer: 'Financial advisers licensed under the FMCA must hold professional indemnity insurance as a licensing requirement. Commercial crime and cyber insurance are not mandated but are strongly recommended by the FMA for firms handling client funds.' },
    ],
  },
  {
  ...
  },
  {
    ...
    metaTitle: 'Professional Services Fraud Insurance NZ | Law, Accounting & Consulting | FraudInsurance.co.nz',
    ...
    faqs: [
      { question: 'Are law firms required to hold trust account fraud insurance?', answer: 'The Law Society requires law firms to maintain appropriate insurance. While not all forms are mandated, the Law Society strongly recommends commercial crime and cyber insurance, particularly for firms managing significant trust account funds in conveyancing.' },
    ],
  },
  {
    ...
    metaTitle: 'Charity & Not-for-Profit Fraud Insurance NZ | Fidelity Cover for NFPs | FraudInsurance.co.nz',
  ...
  },
  {
    ...
    metaTitle: 'Construction & Property Fraud Insurance NZ | BEC & Payment Fraud Cover | FraudInsurance.co.nz',
