...
export const businessTypes: BusinessFraudType[] = [
  {
    ...
    typicalCost: 'Premiums for commercial crime insurance in NZ typically start from around $1,500-$3,000 per year for SMEs, scaling with turnover, employee numbers, and the level of financial controls in place.',
    faqs: [
  ...
  },
  {
    ...
    typicalCost: 'Fidelity insurance premiums for NZ SMEs typically start from around $800-$2,000 per year for basic cover, depending on the number of employees, turnover, and financial controls in place.',
    faqs: [
  ...
  },
  {
    ...
    description: 'Cyber insurance is now essential for NZ businesses of all sizes. A cyber attack or data breach can result in significant costs: forensic investigation, system restoration, business interruption losses, regulatory fines, legal liability to affected customers, and PR/crisis communications. NZ insurers including DUAL, NZI, and Delta Insurance offer cyber products up to $10m in cover.',
    details: 'New Zealand has seen a dramatic rise in cyber attacks on businesses — from ransomware attacks on critical infrastructure to spear-phishing campaigns targeting SMEs. CERT NZ reported thousands of cyber incidents in 2024-2025. The Privacy Act 2020 also creates mandatory breach notification obligations and potential fines, making cyber insurance not just commercially important but legally relevant.',
    ...
    typicalCost: 'Cyber insurance premiums in NZ for SMEs typically start from $1,500-$4,000 per year for $1-2m cover. Larger corporates can access $5-10m limits. Premiums depend on revenue, data holdings, security posture, and industry sector.',
    faqs: [
  ...
  },
  {
    ...
    details: 'Business Email Compromise (BEC) is the most costly form of social engineering fraud in NZ, with criminals intercepting or spoofing email communications to redirect supplier payments to fraudulent accounts. The average NZ BEC loss is significantly higher than other fraud types. Because an employee authorised the payment, standard crime insurance often does not cover these losses without a specific social engineering endorsement.',
