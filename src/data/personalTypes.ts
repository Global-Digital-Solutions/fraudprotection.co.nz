...
export const personalTypes: PersonalFraudType[] = [
  {
    ...
    stats: [
      { label: 'NZ adults who encountered identity fraud', value: '1 in 5' },
    ...
    whereToGo: [
      { name: 'IDCARE', url: 'https://www.idcare.org/new-zealand', description: 'Free identity & cyber support service for New Zealanders' },
    ...
    faqs: [
      { question: 'Is there identity theft insurance in NZ?', answer: 'There is no standalone identity theft insurance product available in New Zealand. However, your bank\'s zero-liability guarantee covers fraudulent transactions, and some cyber insurance policies include identity restoration cover. The free IDCARE service provides expert support for recovery.' },
      { question: 'What should I do if my identity is stolen in NZ?', answer: 'Act immediately: report to NZ Police (105), contact IDCARE (0800 432 273), notify your bank, alert the three credit bureaus (Centrix, Equifax, Illion) to place a fraud alert, and report to the relevant government agencies if your IRD number or passport has been misused.' },
      ...
      { question: 'What is a credit fraud alert in NZ?', answer: 'A fraud alert notifies lenders to take extra verification steps before approving credit in your name. You can request this from NZ\'s three credit bureaus — Centrix, Equifax NZ, and Illion. This makes it harder for identity thieves to open new accounts.' },
    ],
  ...
  },
  {
    ...
    stats: [
      { label: 'NZ card fraud losses per year', value: '$100m+' },
    ...
    faqs: [
      { question: 'Will my NZ bank refund card fraud?', answer: 'Yes — all five major NZ banks (ANZ, BNZ, ASB, Westpac, Kiwibank) offer zero-liability guarantees on eligible accounts for unauthorised card transactions. You must report the fraud promptly and have followed the bank\'s security guidelines (e.g., not sharing your PIN). Contact your bank immediately if you spot unauthorised transactions.' },
      { question: 'How quickly must I report card fraud in NZ?', answer: 'Report as soon as you discover it. The sooner you report, the better your chances of full recovery. Banks generally require you to report within a reasonable time. Leaving it weeks or months before reporting may affect your ability to claim.' },
  ...
  },
  {
    ...
    icon: '🎣',
    tagline: 'Phishing, fake websites, romance scams, and investment fraud — protecting New Zealanders from digital deception.',
    description: 'Online scams are the fastest-growing form of fraud in New Zealand, with $3 billion lost in 2025 alone. Scams include phishing emails and texts, fake investment platforms, romance and relationship scams, online marketplace fraud, and impersonation of banks, IRD, or government agencies. Unlike card fraud, scam losses are harder to recover because victims voluntarily authorise the payment.',
    details: 'When you are tricked into sending money to a scammer, banks may not automatically refund the loss — because you authorised the payment. New Zealand is working toward a Scam Code similar to the UK\'s voluntary code, but currently there is no mandatory reimbursement obligation. Prevention, reporting to Netsafe and Police, and acting quickly to try to reverse transactions are your main options.',
    ...
    stats: [
      { label: 'NZ scam losses in 2025', value: '$3 billion' },
      { label: 'Increase from 2024', value: '+30%' },
      { label: 'NZ adults who encounter scams weekly', value: '82%' },
    ...
    faqs: [
      { question: 'Will my bank refund me if I\'m scammed in NZ?', answer: 'Only 36% of scam victims who report to their bank in NZ recover their funds, according to 2025 data. Banks distinguish between "authorised" payments (where you sent money, even under false pretences) and "unauthorised" payments (where a fraudster accessed your account without permission). Unauthorised transactions are generally refunded; authorised scam payments are much harder to recover. Act immediately — the faster you report to your bank, the better chance of a recall.' },
      { question: 'What is the fastest-growing scam type in NZ?', answer: 'Investment scams (particularly fake cryptocurrency trading platforms) and business email compromise are among the fastest-growing fraud types in NZ. Romance scams and phishing/smishing also continue to increase year-on-year, with total losses reaching $3 billion in 2025.' },
      { question: 'How do I report a scam in New Zealand?', answer: 'Report to Netsafe (0508 638 723 or www.netsafe.org.nz) for online scams. Report to NZ Police (105) if money has been stolen. Report investment scams to the FMA. Contact your bank immediately to attempt a payment recall. If it involves a government agency impersonation, also report to that agency.' },
      { question: 'Is there scam insurance available in New Zealand?', answer: 'There is no mainstream standalone scam insurance product for individuals in NZ. Some cyber insurance policies include social engineering fraud coverage, which can apply to certain scam losses. Banks\' zero-liability guarantees do not generally cover authorised scam payments. New Zealand is monitoring developments in the UK, where banks have adopted voluntary reimbursement codes for scam victims.' },
    ],
  ...
  },
  {
    ...
    details: 'SIM swap fraud is a particularly damaging form of ATO in New Zealand, where a criminal convinces your mobile carrier to transfer your phone number to a SIM card they control. This bypasses SMS-based two-factor authentication, giving them access to your banking and email. Multi-factor authentication apps (not SMS) and strong, unique passwords are the best defences.',
    ...
    stats: [
      { label: 'NZ adults affected by account compromise', value: '1 in 10' },
      { label: 'Most targeted account type', value: 'Banking apps' },
      { label: 'SIM swap reports to NZ carriers (2024)', value: 'Hundreds p/a' },
    ...
    faqs: [
      { question: 'What is SIM swap fraud and how common is it in NZ?', answer: 'SIM swap fraud involves a criminal impersonating you to your mobile carrier and convincing them to port your phone number to a new SIM. This lets the criminal receive your SMS verification codes, bypassing two-factor authentication. While exact NZ figures aren\'t public, carriers have implemented additional verification steps after a series of high-profile SIM swap fraud cases.' },
  ...
  },
  {
    ...
    stats: [
      { label: 'NZ investment scam losses (2024)', value: '$100m+' },
    ...
    whatItCovers: [
      ...
      'Clone firm scams impersonating licensed NZ advisers',
    ...
    whereToGo: [
      ...
      { name: 'Sorted.org.nz', url: 'https://sorted.org.nz/', description: 'Independent NZ financial guidance' },
      { name: 'Netsafe', url: 'https://www.netsafe.org.nz/', description: 'Report online investment scams' },
    ],
    faqs: [
      { question: 'Can I get my money back from an investment scam in NZ?', answer: 'Recovery of investment scam losses is very difficult in NZ — typically under 10% of victims recover funds. You should immediately report to the FMA and NZ Police, and contact your bank to attempt to trace or reverse any transfers. If funds went overseas, recovery becomes even harder. Acting within the first 24-48 hours gives the best chance of a bank recall.' },
      { question: 'How do I check if an investment is legitimate in NZ?', answer: 'Check the FMA\'s Financial Service Providers Register (FSPR) at fspr.govt.nz to verify the firm is licensed. Check the FMA\'s warning list for known scams. Search for reviews and complaints. Ask for a Product Disclosure Statement (PDS) — all regulated NZ investment offers require one. If any of these checks fail, don\'t invest.' },
      { question: 'What is a "pig butchering" scam?', answer: 'Pig butchering is a sophisticated scam where criminals spend weeks or months building a romantic or friendly relationship with the victim online before introducing an "investment opportunity." Once the victim has "invested" significant funds (been "fattened up"), the criminals take all the money and disappear. These scams are now extremely common in NZ.' },
    ],
