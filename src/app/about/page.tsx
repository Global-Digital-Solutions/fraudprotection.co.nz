...
export const metadata: Metadata = {
  title: 'About FraudInsurance.co.nz | NZ Fraud Insurance Information & Referral Service',
  description: 'About FraudInsurance.co.nz — New Zealand\'s independent guide to personal and business fraud protection insurance. How we work and who we connect you with.',
  alternates: { canonical: 'https://www.fraudinsurance.co.nz/about/' },
};
    ...
    <>
      <section className="relative bg-slate-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">About FraudInsurance.co.nz</h1>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div>
            ...
            <p className="text-slate-700 text-sm leading-relaxed mb-4">
              $3 billion was lost to fraud last year — but many people don't know what protection exists or where to find it. FraudInsurance.co.nz was created to close that knowledge gap.
            </p>
            <p className="text-slate-700 text-sm leading-relaxed">
          ...
          <div>
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              When you submit a business insurance quote request through our website, your enquiry is forwarded to a licensed insurance adviser. The adviser contacts you directly to discuss your needs and provide options. FraudInsurance.co.nz is a referral service — we are not a licensed insurer or financial adviser, and we do not charge you for the referral. Our referral partners are licensed professionals regulated under New Zealand law.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
              <p className="text-sm text-amber-900 leading-relaxed">
                FraudInsurance.co.nz is an information and referral service only. We are not a licensed financial adviser, registered insurance broker, or insurer under New Zealand law. The information published on this website is general in nature and does not constitute personalised financial or insurance advice. Always consult a licensed insurance adviser before purchasing insurance products. Business insurance enquiries submitted through our forms are referred to licensed advisers only — these advisers are regulated under New Zealand law and must act in your best interests.
              </p>
            </div>
          </div>
