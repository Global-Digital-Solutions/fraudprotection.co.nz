          ...
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8">
                <h2 className="text-xl font-bold text-slate-900 mb-1">Your Quote Request</h2>
                <p className="text-slate-500 text-sm mb-7">All fields marked * are required. Takes around 2 minutes.</p>
                <QuoteForm />
              </div>
            </div>
